...
descriptorManager descriptorMan(&app);
skeletalAnimation skelAnim("../anims/scene.gltf");
...
void DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator) {
    ...
    void HelloTriangleApplication::initVulkan() {
        ...
        descriptorMan.createDescriptorSets(mvpSets, bonesSets);
        createFramebuffers();
        createCommandPool();
        createVertexBuffer();
        createIndexBuffer();
    ...
    void HelloTriangleApplication::createGraphicsPipeline() {
        ...
        pipelineLayoutInfo.pSetLayouts = descriptorMan.createDescriptorSetLayouts();
