...
extern HelloTriangleApplication app;
...
/*HelloTriangleApplication::~HelloTriangleApplication() {
    app.deletionQueue.push_function([&]() {
        delete descriptorMan;
    });
}*/

HelloTriangleApplication::HelloTriangleApplication(GLFWcursorposfun mouse_callback, GLFWkeyfun key_callback, GLFWcursorenterfun cursor_enter_callback, GLFWframebuffersizefun frameBufferResizeCallback) {
    this->mouse_callback = mouse_callback;
    this->key_callback = key_callback;
    this->cursor_enter_callback = cursor_enter_callback;
    this->frameBufferResizeCallback = frameBufferResizeCallback;
}

void HelloTriangleApplication::setCallbacks(GLFWcursorposfun mouse_callback, GLFWkeyfun key_callback, GLFWcursorenterfun cursor_enter_callback, GLFWframebuffersizefun frameBufferResizeCallback) {
    this->mouse_callback = mouse_callback;
    this->key_callback = key_callback;
    this->cursor_enter_callback = cursor_enter_callback;
    this->frameBufferResizeCallback = frameBufferResizeCallback;
...
void HelloTriangleApplication::processInput(GLFWwindow* window) {
    if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        playerState.cameraPos += playerState.movementPerUpdate * playerState.cameraFront;
...
void HelloTriangleApplication::cleanup() {
    ...
    //ImGui_ImplVulkanH_DestroyWindow(instance, device, &imguiWd, nullptr);
...
void HelloTriangleApplication::createGraphicsPipeline() {
    ...
    pipelineLayoutInfo.pSetLayouts = descriptorMan.createDescriptorSetLayouts(*this);
